...
public class Bootcamp {
    ...
    private final LocalDate dataInicial = LocalDate.now(); //data que será criado
    private final LocalDate dataFinal = dataInicial.plusDays(45); //data que foi criada + 45 dias
